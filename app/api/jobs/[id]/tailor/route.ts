...
/**
 * `POST /api/jobs/[id]/tailor` — the Tailor tab's "Generate" button (plan
 * Task 9 Step 2). Runs the `tailor` pipeline step against this job's cached
 * `analysis`, the signed-in user's confirmed facts, and — when one exists —
